...
These notes are from [Section 2](https://www.soa.org/4964e1/globalassets/assets/files/resources/research-report/2021/liability-driven-investment.pdf). 
...
The goal of the research report is to then us AI techniques as a dynamic optimization method that can include the evolution of the liability, the nonlinear relationship between asset and liability, and an institution's `risk appetite`. 